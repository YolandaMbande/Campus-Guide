<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=='GET'){
    ...
    $id = $_GET['id'];
    $sql = "select * from campus_guide where id=$id";
    ...
    $sql = "update campus_guide set name='$name', email='$email', phone='$phone' where id='$id'";
    $result = $conn->query($sql);
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" class="fw-bold">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php">Campus Guide Database</a>
